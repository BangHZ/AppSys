...
public class DevController {
    ...
    public String list(@RequestParam(value = "querySoftwareName", defaultValue = "") String querySoftwareName,
        ...
        // 查询app数量
        int totalCount = appInfoService.getTotalCountByCondition(querySoftwareName, queryFlatformId, queryCategoryLevel1, queryCategoryLevel2, queryCategoryLevel3,queryStatus);
        // 判断分页对象是否为空
        if (null != page) {
...
//        System.out.println(querySoftwareName+"："+queryCategoryLevel1+"："+queryCategoryLevel2+"："+queryCategoryLevel3);
        // 查询所有app信息
        List<AppInfo> appList = appInfoService.getAppInfoByCondition(querySoftwareName, queryFlatformId, queryCategoryLevel1, queryCategoryLevel2, queryCategoryLevel3, queryStatus, page);
...
//        System.out.println(tcode);
    ...
    public String appInfoSave(AppInfo appInfo, HttpSession session, @RequestParam(value = "a_logoPicPath", required = false)MultipartFile attach) {
        // 补全app信息
